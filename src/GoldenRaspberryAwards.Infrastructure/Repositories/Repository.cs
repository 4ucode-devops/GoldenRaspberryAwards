using GoldenRaspberryAwards.Core.Common;
...
{
    protected readonly GoldenRaspberryAwardsContext _dataContext;
    protected readonly DbSet<TEntity> _dbSet;
    protected readonly INotifier _notifier;

    protected Repository(GoldenRaspberryAwardsContext dataContext, INotifier notifier)
    {
